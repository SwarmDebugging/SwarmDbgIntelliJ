...
public class SessionToolWindow implements DumbAware {
    ...
    public SessionToolWindow(Session currentSession, ToolWindow toolWindow, Project project) {

        this.toolWindow = toolWindow;

        stopSessionButton.addActionListener(actionEvent -> {
            currentSession.stop();
            switchToolWindowContentToProductToolWindow(new ProductToolWindow(toolWindow, project));
        });
    }
